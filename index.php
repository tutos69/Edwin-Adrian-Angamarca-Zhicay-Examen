...
<body>
    ...
    <div class="animated bounceInDown">
        <div class="container">
            ...
            <form name="form1" class="box" onsubmit="return checkStuff()" action="../Edwin-Adrian-Angamarca-Zhicay-Examen/public/controlador/login.php" method="POST" >
                <h4>Iniciar<span>Sesion</span></h4>
